...
-  ``parser_config_file`` :raw-html:`<a id="parser_config_file" title="Permalink to this parameter" href="#parser_config_file">&#x1F517;&#xFE0E;</a>`, default = ``""``, type = string
   ...
   -  see `falcata-transform <https://github.com/MechaFauna-ai/Falcata-transform>`__ for usage examples

   -  **Note**: ``falcata-transform`` is not maintained by Falcata's maintainers. Bug reports or feature requests should go to `issues page <https://github.com/MechaFauna-ai/Falcata-transform/issues>`__

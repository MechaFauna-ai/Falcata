...
-  `Python Examples <https://github.com/MechaFauna-ai/Falcata/tree/master/examples/python-guide>`__
...
`dataset_from_multi_hdf5.py <https://github.com/MechaFauna-ai/Falcata/blob/master/examples/python-guide/dataset_from_multi_hdf5.py>`__ is a detailed example.
...
.. _Python-package: https://github.com/MechaFauna-ai/Falcata/tree/master/python-package

...
.. code:: python
  ...
  dask_model = flc.DaskFalcataClassifier(client=client)

  # option 2: set_params() after construction
  dask_model = flc.DaskFalcataClassifier()
...
.. code:: python
  ...
  dask_model = flc.DaskFalcataRegressor(machines=machines)
...
.. code:: python
  ...
  dask_model = flc.DaskFalcataRegressor(local_listen_port=12400)
...
.. code:: python
  ...
  dask_model = flc.DaskFalcataRegressor(
...
.. _the Dask prediction example: https://github.com/MechaFauna-ai/Falcata/blob/master/examples/python-guide/dask/prediction.py
...
.. _A simple distributed learning example: https://github.com/MechaFauna-ai/Falcata/tree/master/examples/parallel_learning

...
LOCKS = {
    # re-baselined 2026-07-31: stochastic rounding tables regenerated by the
    # cross-machine determinism fix (fixed-chunk seeding + pinned FMA); same
    # seed now yields these md5s on ANY CUDA GPU / host thread count
    # (verified sm_120 vs sm_89, 32-thread vs 22-thread hosts)
    "covtype": "57d0ef206d27",
    "covtype-classic": "84cad85361eb",
    "numerai": "f4d3f682120f",
}

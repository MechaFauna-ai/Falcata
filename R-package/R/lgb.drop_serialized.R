...
#' @title Drop serialized raw bytes in a Falcata model object
#' @description If a Falcata model object was produced with argument `serializable=TRUE`, the R object will keep

...
Welcome to the world of [Falcata](https://github.com/BelixRogner/Falcata), a highly efficient gradient boosting implementation (Ke et al. 2017).
...
Try it out! If stuck, visit Falcata's [documentation](https://github.com/BelixRogner/Falcata/blob/master/docs/R/index.rst) for more details.

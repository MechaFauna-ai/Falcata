...
#ifndef FALCATA_INCLUDE_LIGHTGBM_CUDA_CUDA_METADATA_HPP_
#define FALCATA_INCLUDE_LIGHTGBM_CUDA_CUDA_METADATA_HPP_
...
#endif  // FALCATA_INCLUDE_LIGHTGBM_CUDA_CUDA_METADATA_HPP_

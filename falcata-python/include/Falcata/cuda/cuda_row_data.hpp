...
#ifndef FALCATA_INCLUDE_LIGHTGBM_CUDA_CUDA_ROW_DATA_HPP_
#define FALCATA_INCLUDE_LIGHTGBM_CUDA_CUDA_ROW_DATA_HPP_
...
class CUDARowData {
 ...
 private:
   ...
   *  the Dataset's column bins (FALCATA_FAST_ROWDATA, default on); host_data (the
...
#endif  // FALCATA_INCLUDE_LIGHTGBM_CUDA_CUDA_ROW_DATA_HPP_

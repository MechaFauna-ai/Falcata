 ...
 */
#ifndef FALCATA_INCLUDE_LIGHTGBM_UTILS_BINARY_WRITER_H_
#define FALCATA_INCLUDE_LIGHTGBM_UTILS_BINARY_WRITER_H_
...
#endif   // FALCATA_INCLUDE_LIGHTGBM_UTILS_BINARY_WRITER_H_

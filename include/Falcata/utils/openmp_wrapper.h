...
*/
FALCATA_EXTERN_C int OMP_NUM_THREADS();

/*
    Update the default number of threads that'll be used in OpenMP parallel
    regions for Falcata routines where the number of threads aren't directly
    supplied.
*/
FALCATA_EXTERN_C void OMP_SET_NUM_THREADS(int num_threads);

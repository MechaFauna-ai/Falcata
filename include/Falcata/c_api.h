...
#if defined(_MSC_VER)
#  define FALCATA_DEPRECATED(msg) __declspec(deprecated(msg))  /*!< \brief Deprecated function. */
#elif defined(__GNUC__) || defined(__clang__)
#  define FALCATA_DEPRECATED(msg) __attribute__((deprecated(msg)))  /*!< \brief Deprecated function. */
#else
#  define FALCATA_DEPRECATED(msg)  /*!< \brief Deprecated function. */
#endif
...
/*!
 * \brief Load dataset from file (like Falcata CLI version does).

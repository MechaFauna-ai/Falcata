 ...
 */
#ifndef FALCATA_INCLUDE_LIGHTGBM_OBJECTIVE_FUNCTION_H_
#define FALCATA_INCLUDE_LIGHTGBM_OBJECTIVE_FUNCTION_H_
...
class ObjectiveFunction {
  ...
  */
  FALCATA_EXPORT static ObjectiveFunction* CreateObjectiveFunction(const std::string& type,
    const Config& config);

  /*!
  * \brief Load objective function from string object
  */
  FALCATA_EXPORT static ObjectiveFunction* CreateObjectiveFunction(const std::string& str);
  ...
  * \param config Config for objective function
  */
  FALCATA_EXPORT static ObjectiveFunction* CreateObjectiveFunctionCUDA(const std::string& type,
    const Config& config);
...
#endif   // FALCATA_INCLUDE_LIGHTGBM_OBJECTIVE_FUNCTION_H_

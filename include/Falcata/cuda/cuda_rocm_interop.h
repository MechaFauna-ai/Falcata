...
#ifndef FALCATA_INCLUDE_LIGHTGBM_CUDA_CUDA_ROCM_INTEROP_H_
#define FALCATA_INCLUDE_LIGHTGBM_CUDA_CUDA_ROCM_INTEROP_H_
...
#endif  // FALCATA_INCLUDE_LIGHTGBM_CUDA_CUDA_ROCM_INTEROP_H_

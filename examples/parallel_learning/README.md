...
For more details about the usage of distributed learning, please refer to [this](https://github.com/MechaFauna-ai/Falcata/blob/master/docs/Parallel-Learning-Guide.rst).

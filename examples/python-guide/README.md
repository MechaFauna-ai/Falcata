...
You should install Falcata [Python-package](https://github.com/BelixRogner/Falcata/tree/master/python-package) first.
...
- [simple_example.py](https://github.com/BelixRogner/Falcata/blob/master/examples/python-guide/simple_example.py)
    - Construct Dataset
    - Basic train and predict
    - Eval during training
    - Early stopping
    - Save model to file
- [sklearn_example.py](https://github.com/BelixRogner/Falcata/blob/master/examples/python-guide/sklearn_example.py)
...
- [advanced_example.py](https://github.com/BelixRogner/Falcata/blob/master/examples/python-guide/advanced_example.py)
    - Construct Dataset
    - Set feature names
    ...
    - Callback function
- [logistic_regression.py](https://github.com/BelixRogner/Falcata/blob/master/examples/python-guide/logistic_regression.py)
...
- [plot_example.py](https://github.com/BelixRogner/Falcata/blob/master/examples/python-guide/plot_example.py)
    - Construct Dataset
...
- [dataset_from_multi_hdf5.py](https://github.com/BelixRogner/Falcata/blob/master/examples/python-guide/dataset_from_multi_hdf5.py)

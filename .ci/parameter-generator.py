...
This script generates Falcata/src/io/config_auto.cpp file
with list of all parameters, aliases table and other routines
along with parameters description in Falcata/docs/Parameters.rst file
from the information in Falcata/include/Falcata/config.h file.
"""
 ...
 *
 * \note
 * This file is auto generated by Falcata\.ci\parameter-generator.py from Falcata\include\Falcata\config.h file.
 */
"""
    str_to_write += "#include <Falcata/config.h>\n\n"
    ...
    str_to_write += "namespace Falcata {\n"
...
if __name__ == "__main__":
    ...
    config_hpp = current_dir.parent / "include" / "Falcata" / "config.h"
